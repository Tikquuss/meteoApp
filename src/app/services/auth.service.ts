 ...
 * @class
 * @classdesc Ce service possede principalement trois methodes :  
 ...
 * c'est-à-dire qu'elles n'ont pas un résultat instantané, les méthodes pour les gérer 
 * retourneront des Promise, ce qui permettra également de gérer les situations 
 * d'erreur. 
*/
